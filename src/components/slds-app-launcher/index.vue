                        ...
                        <ul class="slds-grid slds-grid_pull-padded slds-wrap">
                            <li class="slds-p-horizontal_small slds-size_1-of-1 slds-medium-size_1-of-3">
                                <div draggable="true" class="slds-app-launcher__tile slds-text-link_reset slds-is-draggable">
                                    ...
                                    <div class="slds-app-launcher__tile-body">
                                        <a href="javascript:void(0);">Sales Cloud</a>
                            ...
                            <li class="slds-p-horizontal_small slds-size_1-of-1 slds-medium-size_1-of-3">
                                <div draggable="true" class="slds-app-launcher__tile slds-text-link_reset slds-is-draggable">
                                    ...
                                    <div class="slds-app-launcher__tile-body">
                                        <a href="javascript:void(0);">Marketing Cloud</a>
                            ...
                            <li class="slds-p-horizontal_small slds-size_1-of-1 slds-medium-size_1-of-3">
                                <div draggable="true" class="slds-app-launcher__tile slds-text-link_reset slds-is-draggable">
                                    ...
                                    <div class="slds-app-launcher__tile-body">
                                        <a href="javascript:void(0);">HR Concierge</a>
                            ...
                            <li class="slds-p-horizontal_small slds-size_1-of-1 slds-medium-size_1-of-3">
                                <div draggable="true" class="slds-app-launcher__tile slds-text-link_reset slds-is-draggable">
                                    ...
                                    <div class="slds-app-launcher__tile-body">
                                        <a href="javascript:void(0);">My Money</a>
                            ...
                            <li class="slds-p-horizontal_small slds-size_1-of-1 slds-medium-size_1-of-3">
                                <div draggable="true" class="slds-app-launcher__tile slds-text-link_reset slds-is-draggable">
                                    ...
                                    <div class="slds-app-launcher__tile-body">
                                        <a href="javascript:void(0);">Customer Support Community</a>
                    ...
                    <div aria-hidden="false" class="slds-section__content" id="itemsContent">
                        <ul class="slds-grid slds-wrap">
                            <li class="slds-col_padded slds-p-vertical_xx-small slds-size_1-of-5">
                                <a href="javascript:void(0);" class="slds-truncate" title="Accounts">Accounts</a>
                            </li>
                            <li class="slds-col_padded slds-p-vertical_xx-small slds-size_1-of-5">
                                <a href="javascript:void(0);" class="slds-truncate" title="Announcements">Announcements</a>
                            </li>
                            <li class="slds-col_padded slds-p-vertical_xx-small slds-size_1-of-5">
                                <a href="javascript:void(0);" class="slds-truncate" title="Approvals">Approvals</a>
                            </li>
                            <li class="slds-col_padded slds-p-vertical_xx-small slds-size_1-of-5">
                                <a href="javascript:void(0);" class="slds-truncate" title="Campaigns">Campaigns</a>
                            </li>
                            <li class="slds-col_padded slds-p-vertical_xx-small slds-size_1-of-5">
                                <a href="javascript:void(0);" class="slds-truncate" title="Cases">Cases</a>
                            </li>
                            <li class="slds-col_padded slds-p-vertical_xx-small slds-size_1-of-5">
                                <a href="javascript:void(0);" class="slds-truncate" title="Coaching">Coaching</a>
                            </li>
                            <li class="slds-col_padded slds-p-vertical_xx-small slds-size_1-of-5">
                                <a href="javascript:void(0);" class="slds-truncate" title="Contacts">Contacts</a>
                            </li>
                        </ul>
                    </div>
                </div>
