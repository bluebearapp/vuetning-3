                ...
                <div class="slds-form-element__group">
                    <div class="slds-form-element__row">
                        <div class="slds-form-element slds-dropdown-trigger slds-dropdown-trigger_click slds-is-open">
                            <label class="slds-form-element__label" for="text-input-unique-id-7">Date</label>
                            <div class="slds-form-element__control slds-input-has-icon slds-input-has-icon_right">
                                <input type="text" id="text-input-unique-id-7" placeholder=" " class="slds-input" />
                            ...
                            <div aria-hidden="false" aria-label="Date picker: June" class="slds-datepicker slds-dropdown slds-dropdown_left" role="dialog">
                                <div class="slds-datepicker__filter slds-grid">
                                    <div class="slds-datepicker__filter_month slds-grid slds-grid_align-spread slds-grow">
                                        ...
                                        <h2 aria-atomic="true" aria-live="assertive" class="slds-align-middle" id="undefined-month">June</h2>
                                        <div class="slds-align-middle">
                                    ...
                                    <div class="slds-shrink-none">
                                        <label class="slds-assistive-text" for="undefined_select">Pick a Year</label>
                                        <div class="slds-select_container">
                                            <select class="slds-select" id="undefined_select">
                                                <option>2020</option>
                                                <option>2021</option>
                                                <option>2022</option>
                                            </select>
                        ...
                        <div class="slds-form-element">
                            <label class="slds-form-element__label" for="combobox-unique-id-3">Time</label>
                            <div class="slds-form-element__control">
                                <div class="slds-combobox_container">
                                    <div class="slds-combobox slds-dropdown-trigger slds-dropdown-trigger_click slds-combobox-picklist slds-timepicker" aria-expanded="false" aria-haspopup="listbox" role="combobox">
                                        <div class="slds-combobox__form-element slds-input-has-icon slds-input-has-icon_right" role="none">
                                            <input type="text" class="slds-input slds-combobox__input" id="combobox-unique-id-3" aria-autocomplete="list" autoComplete="off" role="textbox" placeholder=" " />
