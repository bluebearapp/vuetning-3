                    ...
                    <div id="color-picker-custom" class="slds-tabs_default__content slds-hide" role="tabpanel" aria-labelledby="color-picker-custom__item">
                        <div class="slds-color-picker__custom">
                            ...
                            <div class="slds-color-picker__hue-and-preview">
                                <label class="slds-assistive-text" for="color-picker-input-range-3">Select Hue</label>
                                <input type="range" class="slds-color-picker__hue-slider" min="0" max="360" id="color-picker-input-range-3" value="208" />
                            ...
                            <div class="slds-color-picker__custom-inputs">
                                <div class="slds-form-element slds-color-picker__input-custom-hex">
                                    <label class="slds-form-element__label" for="color-picker-input-hex-3">Hex</label>
                                    <div class="slds-form-element__control">
                                        <input type="text" id="color-picker-input-hex-3" class="slds-input" value="#5679C0" />
                                    </div>
                                </div>
                                <div class="slds-form-element">
                                    ...
                                    <div class="slds-form-element__control">
                                        <input type="text" id="color-picker-input-r-3" class="slds-input" value="86" />
                                    </div>
                                </div>
                                <div class="slds-form-element">
                                    ...
                                    <div class="slds-form-element__control">
                                        <input type="text" id="color-picker-input-g-3" class="slds-input" value="121" />
                                    </div>
                                </div>
                                <div class="slds-form-element">
                                    ...
                                    <div class="slds-form-element__control">
                                        <input type="text" id="color-picker-input-b-3" class="slds-input" value="192" />
                                    </div>
                                </div>
                            </div>
                        </div>
